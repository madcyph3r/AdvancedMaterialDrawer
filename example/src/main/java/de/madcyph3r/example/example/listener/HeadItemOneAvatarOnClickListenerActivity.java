 ...
 */
public class HeadItemOneAvatarOnClickListenerActivity extends MaterialNavigationDrawer {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        instruction.setFragmentTitle("Head Item Style (One Item), Avatar OnClick Listener");
