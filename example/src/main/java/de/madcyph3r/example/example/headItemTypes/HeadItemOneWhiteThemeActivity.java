 ...
 */
public class HeadItemOneWhiteThemeActivity extends MaterialNavigationDrawer {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        bundle.putString("instruction", "This example shows the head item style with the white theme. " +
                "See the method headerType in the source code and AndroidManifest.xml, to set the white theme.");
        ...
        instruction.setFragmentTitle("Head Item Style (One Item) White Theme");
